  ...
  return (
    <section className="relative overflow-hidden bg-carvao min-h-[88vh] md:min-h-[92vh] flex items-center">
      {/* Foto principal do ambiente, com abertura 3D da esquerda para a direita.
          Duas versões (mobile/desktop) evitam que a imagem fique esticada e borrada. */}
      <div className="absolute inset-0">
        <Image
          ...
          priority
          sizes="100vw"
          className="object-cover animate-abrir-3d md:hidden"
        />
        <Image
          ...
          priority
          sizes="100vw"
          className="object-cover animate-abrir-3d hidden md:block"
        />
      </div>
