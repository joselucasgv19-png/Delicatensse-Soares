...
export default function CTASection({
  ...
  return (
    <section className="relative overflow-hidden bg-vinho">
      ...
      <div className="container-page relative py-14 sm:py-16 md:py-20 text-center flex flex-col items-center gap-5 sm:gap-6">
        <h2 className="font-display text-2xl sm:text-3xl md:text-5xl text-creme max-w-2xl">
          {titulo}
        </h2>
        <p className="text-creme/85 max-w-xl text-sm sm:text-base md:text-lg leading-relaxed">
          {texto}
        </p>
