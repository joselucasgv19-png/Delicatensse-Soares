...
export const metadata: Metadata = {
  title: "Localização",
  description:
    "Encontre a Delicatessen Soares: endereço, horário de funcionamento e como chegar.",
};
      ...
      <section className="bg-creme">
        <div className="container-page py-16 md:py-20 grid lg:grid-cols-[1.1fr_1fr] gap-10">
          <div className="rounded-3xl overflow-hidden border border-texto/10 h-80 lg:h-auto min-h-[24rem]">
            <iframe
              title="Mapa da Delicatessen Soares"
              src={mapaSrc}
          ...
          <div className="flex flex-col gap-8">
            ...
            <WhatsAppButton
              variante="inline"
              mensagem="Olá! Gostaria de reservar uma mesa na Delicatessen Soares."
            />
          </div>
        </div>
      </section>
