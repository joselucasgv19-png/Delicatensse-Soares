...
export const metadata: Metadata = {
  title: "Depoimentos",
  description:
    "Veja o que os clientes da Delicatessen Soares têm a dizer sobre nossa qualidade e atendimento.",
};
  ...
  return (
    <>
      <PageHero
        ...
        descricao="Histórias reais de quem já faz da Delicatessen Soares parte da rotina."
      />
