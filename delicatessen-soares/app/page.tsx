    ...
    <>
        ...
        <div className="container-page py-20 md:py-24 grid md:grid-cols-2 gap-12 items-center">
          <div>
            <SectionHeading
              ...
              descricao="Na Delicatessen Soares, cada detalhe foi pensado para tornar sua experiência mais agradável — desde a escolha dos produtos até o momento de levar para casa aquilo que você gosta."
            />
            ...
            <FotoReal
              ...
              alt="Clientes reunidos em uma mesa da Delicatessen Soares, em ambiente aconchegante"
              tomHover="brasa"
              className="mt-8 h-56 sm:h-64 rounded-2xl"
            />
          </div>
          <FotoReal
            src="/images/tabua-frios.jpg"
            alt="Tábua de frios e queijos da Delicatessen Soares"
            tomHover="vinho"
      ...
      <section className="bg-carvao textura-carvao">
        <div className="container-page py-20 md:py-24">
          <SectionHeading
            rotulo="Diferenciais"
            titulo="Por que escolher a Delicatessen Soares"
            tom="escuro"
            alinhamento="centro"
          />
      ...
      <section className="bg-creme">
        <div className="container-page py-20 md:py-24 grid md:grid-cols-2 gap-12 items-center">
          <FotoReal
            ...
            alt="Ambiente interno da Delicatessen Soares"
            tomHover="vinho"
      ...
      <CTASection
        ...
        texto="Para aquele café especial, para compartilhar com a família ou simplesmente para se presentear com algo gostoso, a Delicatessen Soares está pronta para fazer parte dos seus melhores momentos."
      />
    </>
  );
}
