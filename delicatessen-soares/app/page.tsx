    ...
    <>
      ...
      <section className="bg-creme">
        <div className="container-page py-20 md:py-24 grid md:grid-cols-2 gap-12 items-center">
          ...
          <FotoCena
            icone={<IconeTabua className="w-full h-full" />}
            tom="manteiga"
            legenda="Ambiente de madeira e luz quente"
      ...
      <section className="bg-creme">
        <div className="container-page py-20 md:py-24 grid md:grid-cols-2 gap-12 items-center">
          <FotoCena
            icone={<IconePin className="w-full h-full" />}
            tom="vinho"
            legenda="Mapa ilustrativo — substitua pela localização real"
