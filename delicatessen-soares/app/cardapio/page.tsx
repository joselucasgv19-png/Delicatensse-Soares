...
export const metadata: Metadata = {
  title: "Cardápio",
  description:
    "Confira o cardápio completo da Delicatensse Soares: padaria, frios e queijos, sanduíches, doces e bebidas.",
};
  ...
  return (
    <>
      <PageHero
        ...
        titulo="Tudo o que você encontra na Delicatensse Soares"
