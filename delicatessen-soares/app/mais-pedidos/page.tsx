...
export const metadata: Metadata = {
  title: "Mais Pedidos",
  description:
    "Descubra os itens mais pedidos pelos nossos clientes na Delicatessen Soares.",
};
  ...
  return (
    <>
      ...
      <CTASection
        ...
        texto="Fale com a gente pelo WhatsApp e monte seu pedido com o que há de mais pedido na Delicatessen Soares."
        mensagemWhatsapp="Olá! Quero pedir os itens Mais Pedidos da Delicatessen Soares."
      />
    </>
  );
}
