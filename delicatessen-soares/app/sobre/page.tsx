...
export const metadata: Metadata = {
  title: "Sobre",
  description:
    "Conheça a história e o conceito da Delicatensse Soares: sabor, qualidade e o prazer de encontrar tudo em um só lugar.",
};
  ...
  return (
    <>
      <PageHero
        ...
        descricao="Conheça o conceito por trás da Delicatensse Soares."
      />
      ...
      <section className="bg-creme">
        <div className="container-page py-16 md:py-20 grid md:grid-cols-2 gap-14 items-start">
          <div className="space-y-6 text-texto/80 leading-relaxed text-lg">
            <p>
              Na Delicatensse Soares, cada detalhe foi pensado para tornar
          ...
          <FotoReal
            src="/images/pao-artesanal.jpg"
            alt="Pão de fermentação natural fatiado, assado na Delicatensse Soares"
            tomHover="brasa"
      ...
      <section className="bg-carvao textura-carvao">
        <div className="container-page py-20 md:py-24">
          <SectionHeading
            rotulo="Por que escolher a Delicatensse Soares"
      ...
      <section className="bg-creme">
        <div className="container-page py-20 md:py-24 max-w-3xl">
          ...
          <p className="mt-6 text-texto/75 leading-relaxed text-lg">
            A Delicatensse Soares busca oferecer justamente isso: um lugar
      ...
      <CTASection
        titulo="Visite a Delicatensse Soares"
